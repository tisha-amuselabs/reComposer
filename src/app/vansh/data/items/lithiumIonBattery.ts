...
export const LITHIUM_ION_BATTERY: ItemOfDay = {
  ...
  alchemy: {
    nodes: {
      "lithium-cobalt-oxide": { id: "lithium-cobalt-oxide", label: "Lithium cobalt oxide", emoji: "⚫" },
      graphite: { id: "graphite", label: "Graphite", emoji: "⬛" },
      "copper-foil": { id: "copper-foil", label: "Copper foil", emoji: "🟧" },
      "aluminum-foil": { id: "aluminum-foil", label: "Aluminum foil", emoji: "⬜" },
      electrolyte: { id: "electrolyte", label: "Liquid electrolyte", emoji: "🧴" },
      stir: { id: "stir", label: "Stir", emoji: "🌀" },
      pressurize: { id: "pressurize", label: "Pressurize", emoji: "⇅" },
      "cathode-slurry": { id: "cathode-slurry", label: "Cathode slurry", emoji: "🥣" },
      "anode-slurry": { id: "anode-slurry", label: "Anode slurry", emoji: "🥣" },
      "coated-cathode": { id: "coated-cathode", label: "Coated cathode", emoji: "🧯" },
      "coated-anode": { id: "coated-anode", label: "Coated anode", emoji: "🧯" },
      "wound-cell": { id: "wound-cell", label: "Wound cell", emoji: "🌀" },
      "filled-cell": { id: "filled-cell", label: "Filled cell", emoji: "🧪" },
      "lithium-ion-battery": { id: "lithium-ion-battery", label: "Lithium-ion battery", emoji: "🔋" },
    },
    startIds: [
      "lithium-cobalt-oxide",
      "graphite",
